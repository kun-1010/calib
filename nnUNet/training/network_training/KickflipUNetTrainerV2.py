...
from nnunet.network_architecture.Kickflip_UNet import KickFlip_UNet
...
class KickflipUNetTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            # now wrap the loss
            self.loss = KickFlipLoss(self.loss, self.ds_loss_weights)
            ################# END ###################
    ...
    def initialize_network(self):
        ...
        self.network = KickFlip_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
    ...
    def initialize_optimizer_and_scheduler(self):
        ...
        self.optimizer = torch.optim.SGD(self.network.parameters(), self.initial_lr, weight_decay=self.weightself.weight_decay,
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        output, kick_flip = self.network(data)

        loss = self.loss(output, target, kick_flip)
