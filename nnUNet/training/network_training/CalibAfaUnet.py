...
from nnunet.network_architecture.Calib_afa_unet import Calib_afa_unet
from nnunet.training.loss_functions.deep_supervision import BratsDiceLoss
...
class CalibflipSwinUnet(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = Calib_afa_unet(hidden_dim=32, layers=(2, 2, 4, 2), heads=(3, 6, 9, 12), num_classes = 4, in_channel = 4,  window_size = [4, 4, 4])
