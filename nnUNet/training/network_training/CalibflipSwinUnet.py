...
from nnunet.network_architecture.Calib_flip_attention import Calibflip_attUNet
from nnunet.network_architecture.SwinUnet_3D import SwinUnet3D
from nnunet.training.loss_functions.deep_supervision import CalibflipLoss, BratsDiceLoss
...
class CalibflipSwinUnet(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = SwinUnet3D(hidden_dim=32, layers=(2, 2, 4, 2), heads=(3, 6, 9, 12), num_classes = 4, in_channel = 4,  window_size = [4, 4, 4])
    ...
    def show_diff_pixel(self, flip_matrix, target, image, epoch):
        ...
        return super().show_diff_pixel(flip_matrix, target, image, epoch)
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False ):
        ...
        # output, kick_flip, calib = self.network(data)
        ...
        # #if 'case_00020' == keys[0]:
        #     self.show_diff_pixel(kick_flip, target, data, self.epoch)
