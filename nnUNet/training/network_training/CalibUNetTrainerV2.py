...
from nnunet.network_architecture.Calib_UNet import Calib_UNet
...
class CalibUNetTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Calib_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
