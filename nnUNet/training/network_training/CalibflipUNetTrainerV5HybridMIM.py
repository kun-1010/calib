...
from nnunet.network_architecture.deep_unet_v2 import DeepUNet
...
class CalibflipUNetTrainerV5HybridMIM(nnUNetTrainer):
    """
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False ):
        ...
        model = self.network(data)
        loss = hybrid_loss(model)
