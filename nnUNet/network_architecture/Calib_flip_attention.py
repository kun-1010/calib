...
class Calibflip_attUNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Calibflip_attUNet, self).__init__()
        ...
        self.kick_outputs = []
        # self.cbam = []
        # self.cbam.append(CBAM(channel=32))
        # self.cbam.append(CBAM(channel=64))
        # self.cbam.append(CBAM(channel=128))
        # self.cbam.append(CBAM(channel=256))
        self.cbam1 = CBAM(channel=32)
        self.cbam2 = CBAM(channel=64)
        self.cbam3 = CBAM(channel=128)
        self.cbam4 = CBAM(channel=256)
        self.cbam5 = CBAM(channel=320)
