...
class SwinUnet3D(SegmentationNetwork):
    def __init__(self, *, hidden_dim, layers, heads, in_channel=1, num_classes=4, head_dim=32,
...
def swinUnet_t_3D(hidden_dim=32, layers=(2, 2, 4, 2), heads=(3, 6, 9, 12), num_classes: int = 2, **kwargs):
