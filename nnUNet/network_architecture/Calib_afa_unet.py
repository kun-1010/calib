...
class WindowAttention3D(nn.Module):
    ...
    def forward(self, x):
        ...
        attn_ = einsum('b h w i d, b h w j d -> b h w i j', q, k)
        ...
        attn_copy = attn_.clone().reshape(b, self.num_heads, n_x, n_y, n_z, attn.shape[-1],)
...
class Calib_afa_unet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Calib_afa_unet, self).__init__()
        ...
        self.attn = Attention(
            4,
            num_heads=self.heads[0], qkv_bias=False, qk_scale=None,
